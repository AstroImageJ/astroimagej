...
import static Astronomy.MultiPlot_.T0;
import static Astronomy.MultiPlot_.autoUpdatePrior;
import static Astronomy.MultiPlot_.baseline;
import static Astronomy.MultiPlot_.bpLock;
import static Astronomy.MultiPlot_.bpSpinner;
import static Astronomy.MultiPlot_.color;
import static Astronomy.MultiPlot_.colorIndex;
import static Astronomy.MultiPlot_.colorOf;
import static Astronomy.MultiPlot_.dMarker1Value;
import static Astronomy.MultiPlot_.dMarker2Value;
import static Astronomy.MultiPlot_.dMarker3Value;
import static Astronomy.MultiPlot_.dMarker4Value;
import static Astronomy.MultiPlot_.detrend;
import static Astronomy.MultiPlot_.detrendFactor;
import static Astronomy.MultiPlot_.detrendFitIndex;
import static Astronomy.MultiPlot_.detrendVarAllNaNs;
import static Astronomy.MultiPlot_.detrendXs;
import static Astronomy.MultiPlot_.detrendYAverage;
import static Astronomy.MultiPlot_.detrendYDNotConstant;
import static Astronomy.MultiPlot_.detrendYEs;
import static Astronomy.MultiPlot_.detrendYs;
import static Astronomy.MultiPlot_.detrendcolumn;
import static Astronomy.MultiPlot_.divideNotSubtract;
import static Astronomy.MultiPlot_.duration;
...
import static Astronomy.MultiPlot_.fitLeft;
import static Astronomy.MultiPlot_.fitMax;
import static Astronomy.MultiPlot_.fitMin;
import static Astronomy.MultiPlot_.fitRight;
import static Astronomy.MultiPlot_.fitStepStep;
import static Astronomy.MultiPlot_.forceCircularOrbit;
import static Astronomy.MultiPlot_.fromMag;
import static Astronomy.MultiPlot_.getFitStep;
import static Astronomy.MultiPlot_.hasErrors;
import static Astronomy.MultiPlot_.hasOpErrors;
import static Astronomy.MultiPlot_.holdExcludedHeadSamples;
import static Astronomy.MultiPlot_.holdExcludedTailSamples;
import static Astronomy.MultiPlot_.inputAverageOverSize;
import static Astronomy.MultiPlot_.isRefStar;
import static Astronomy.MultiPlot_.lockToCenter;
import static Astronomy.MultiPlot_.lonAscNode;
import static Astronomy.MultiPlot_.marker;
import static Astronomy.MultiPlot_.markerIndex;
import static Astronomy.MultiPlot_.markerOf;
import static Astronomy.MultiPlot_.maxColumnLength;
import static Astronomy.MultiPlot_.maxCurves;
import static Astronomy.MultiPlot_.maxDetrendVars;
import static Astronomy.MultiPlot_.maxFitSteps;
import static Astronomy.MultiPlot_.mfMarker1Value;
import static Astronomy.MultiPlot_.modelColor;
import static Astronomy.MultiPlot_.modelColorIndex;
import static Astronomy.MultiPlot_.n;
import static Astronomy.MultiPlot_.nFitTrim;
import static Astronomy.MultiPlot_.negateMag;
import static Astronomy.MultiPlot_.netPeriod;
import static Astronomy.MultiPlot_.netT0;
...
import static Astronomy.MultiPlot_.operatorBase;
import static Astronomy.MultiPlot_.operrcolumn;
import static Astronomy.MultiPlot_.oplabel;
import static Astronomy.MultiPlot_.orbitalPeriod;
import static Astronomy.MultiPlot_.period;
import static Astronomy.MultiPlot_.periodAlias;
import static Astronomy.MultiPlot_.pixelScale;
import static Astronomy.MultiPlot_.plotY;
import static Astronomy.MultiPlot_.plottedResidual;
import static Astronomy.MultiPlot_.priorCenterSpinner;
import static Astronomy.MultiPlot_.priorCenterStep;
import static Astronomy.MultiPlot_.priorWidthStep;
import static Astronomy.MultiPlot_.residual;
import static Astronomy.MultiPlot_.residualColor;
import static Astronomy.MultiPlot_.residualColorIndex;
import static Astronomy.MultiPlot_.residualModelColor;
import static Astronomy.MultiPlot_.residualModelColorIndex;
import static Astronomy.MultiPlot_.residualSymbol;
import static Astronomy.MultiPlot_.residualSymbolIndex;
import static Astronomy.MultiPlot_.setupDataBuffers;
import static Astronomy.MultiPlot_.showXAxisAsDaysSinceTc;
import static Astronomy.MultiPlot_.showXAxisAsHoursSinceTc;
import static Astronomy.MultiPlot_.showXAxisAsPhase;
import static Astronomy.MultiPlot_.showXAxisNormal;
import static Astronomy.MultiPlot_.sigma;
import static Astronomy.MultiPlot_.smooth;
import static Astronomy.MultiPlot_.table;
import static Astronomy.MultiPlot_.tolerance;
import static Astronomy.MultiPlot_.twoxPeriod;
import static Astronomy.MultiPlot_.unfilteredColumns;
import static Astronomy.MultiPlot_.updateColumnLists;
...
import static Astronomy.MultiPlot_.useLonAscNode;
import static Astronomy.MultiPlot_.useNelderMeadChi2ForDetrend;
import static Astronomy.MultiPlot_.usePixelScale;
import static Astronomy.MultiPlot_.useTransitFit;
import static Astronomy.MultiPlot_.vMarker1Value;
import static Astronomy.MultiPlot_.vMarker2Value;
import static Astronomy.MultiPlot_.x;
import static Astronomy.MultiPlot_.xExponent;
import static Astronomy.MultiPlot_.xMax;
import static Astronomy.MultiPlot_.xMin;
import static Astronomy.MultiPlot_.xModel1;
import static Astronomy.MultiPlot_.xModel2;
import static Astronomy.MultiPlot_.xMultiplierFactor;
import static Astronomy.MultiPlot_.xOffset;
import static Astronomy.MultiPlot_.xPlotMax;
import static Astronomy.MultiPlot_.xPlotMin;
import static Astronomy.MultiPlot_.xPlotMinRaw;
import static Astronomy.MultiPlot_.xautoscalemax;
import static Astronomy.MultiPlot_.xautoscalemin;
import static Astronomy.MultiPlot_.xc1;
import static Astronomy.MultiPlot_.xc1column;
import static Astronomy.MultiPlot_.xc2;
import static Astronomy.MultiPlot_.xc2column;
import static Astronomy.MultiPlot_.xcolumn;
import static Astronomy.MultiPlot_.xlabel;
import static Astronomy.MultiPlot_.xlabel2;
import static Astronomy.MultiPlot_.xlabeldefault;
import static Astronomy.MultiPlot_.y;
import static Astronomy.MultiPlot_.yAverage;
import static Astronomy.MultiPlot_.yBaselineAverage;
import static Astronomy.MultiPlot_.yDepthEstimate;
import static Astronomy.MultiPlot_.yExponent;
import static Astronomy.MultiPlot_.yModel1Err;
import static Astronomy.MultiPlot_.yMultiplierFactor;
import static Astronomy.MultiPlot_.yc1;
import static Astronomy.MultiPlot_.yc1column;
import static Astronomy.MultiPlot_.yc2;
import static Astronomy.MultiPlot_.yc2column;
import static Astronomy.MultiPlot_.ycolumn;
import static Astronomy.MultiPlot_.yerr;
import static Astronomy.MultiPlot_.ylabel;
import static Astronomy.MultiPlot_.yop;
import static Astronomy.MultiPlot_.yoperr;
...
public class CurveFitter {
    ...
    private OptimizerResults updateCurve(boolean[] isRefStar, int[] detrendIndex) {
        ...
        var detrend = Arrays.stream(MultiPlot_.detrend[curve]).map(double[]::clone).toArray(_ -> MultiPlot_.detrend[curve].clone());
