...
public abstract class OutputEncoder {
    ...
    /**
     * Returns the number of <i>encoded</i> bytes that were written to the output. It does not include bytes written
     * directly (unencoded) to the output, such as via {@link #write(int)} or {@link #write(byte[], int, int)}.
     *
    ...
    /**
     * Makes sure that there is room in the conversion buffer for an upcoming element conversion, and flushes the buffer
     * as necessary to make room. Subclass implementations should call this method before attempting a conversion
     * operation.
     *
     * @param  bytes       the size of an element we will want to convert. It cannot exceed the size of the conversion
     *                         buffer.
     *
     * @throws IOException if the conversion buffer could not be flushed to the output to make room for the new
     *                         conversion.
     */
    ...
    /**
     * Writes a byte directly to the output. See the general contract of {@link java.io.DataOutputStream#write(int)}.
     * Unencoded bytes written by this method are not reflected in the value returned by {@link #getCount()}.
     *
    ...
    /**
     * Writes up to the specified number of bytes from a buffer directly to the output. See the general contract of
     * {@link java.io.DataOutputStream#write(byte[], int, int)}. The number of unencoded bytes written by this method
     * are not reflected in the value returned by {@link #getCount()}.
     *
     * @param  b           the buffer
     ...
     * argument may be any generic Java array, including heterogeneous arrays of arrays.
     *
    ...
    protected final class OutputBuffer {
        ...
        /**
         * Puts a single byte into the conversion buffer, making space for it as needed by flushing the current buffer
         * contents to the output as necessary.
         *
        ...
        /**
         * Puts a 2-byte integer into the conversion buffer, making space for it as needed by flushing the current
         * buffer contents to the output as necessary.
         *
        ...
        /**
         * Puts a 4-byte integer into the conversion buffer, making space for it as needed by flushing the current
         * buffer contents to the output as necessary.
         *
        ...
        /**
         * Puts an 8-byte integer into the conversion buffer, making space for it as needed by flushing the current
         * buffer contents to the output as necessary.
         *
        ...
        /**
         * Puts an 8-byte double-precision floating point value into the conversion buffer, making space for it as
         * needed by flushing the current buffer contents to the output as necessary.
         *
        ...
        /**
         * Puts an array of bytes into the conversion buffer, flushing the buffer intermittently as necessary to make
         * room as it goes.
         *
        ...
        /**
         * Puts an array of 16-bit integers into the conversion buffer, flushing the buffer intermittently as necessary
        ...
        /**
         * Puts an array of 32-bit integers into the conversion buffer, flushing the buffer intermittently as necessary
         * to make room as it goes.
         *
        ...
        /**
         * Puts an array of 64-bit integers into the conversion buffer, flushing the buffer intermittently as necessary
         * to make room as it goes.
         *
        ...
        /**
         * Puts an array of 32-bit single-precision floating point values into the conversion buffer, flushing the
         * buffer intermittently as necessary to make room as it goes.
         *
        ...
        /**
         * Puts an array of 64-bit double-precision floating point values into the conversion buffer, flushing the
         * buffer intermittently as necessary to make room as it goes.
         *
