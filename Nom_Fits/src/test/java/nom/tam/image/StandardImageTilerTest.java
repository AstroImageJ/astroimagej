...
public class StandardImageTilerTest {
    ...
    public void testFillTileNegativeBounds() throws Exception {
        ...
        Assertions.assertEquals(1, tile[3]);
        tile[3] = 0;
        // check the rest should be 0
        Assertions.assertArrayEquals(new int[25], tile);
    }
    ...
    public void testFillTileOutOfBounds() throws Exception {
        ...
        int[] tile = new int[25];
        tiler.fillTile(null, tile, newDims, corners, lengths);
        Assertions.assertEquals(1, tile[0]);
        tile[0] = 0;
        // check the rest should be 0
        Assertions.assertArrayEquals(new int[25], tile);
    }
    ...
    public void testFillFileData() throws Exception {
        ...
        Assertions.assertEquals(length, output.length);
    }
    ...
    public void testFillFileDataStep() throws Exception {
        ...
        try (final ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            ...
            Assertions.assertEquals((length / step) * baseLength, output.length);
        }
    }
    ...
    public void testFillFileDataDefaultStep() throws Exception {
        ...
        try (final ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            ...
            final byte[] output = byteArrayOutputStream.toByteArray();
            Assertions.assertEquals(length * baseLength, output.length);
        }
    }
    ...
    public void testFillMemdataTileNegativeBounds() throws Exception {
        ...
        Assertions.assertEquals(1, tile[1]);
        tile[1] = 0;
        // check the rest should be 0
        Assertions.assertArrayEquals(new int[25], tile);
    }
    ...
    public void testFillMemdataTileStep() throws Exception {
        ...
        Assertions.assertArrayEquals(expectedTile, tile);
    ...
    public void testIncrementPositionBackwardCompatibility() {
        ...
        Assertions.assertTrue(StandardImageTiler.incrementPosition(start, current, lengths));
        Assertions.assertArrayEquals(new int[] {1, 0}, current);

        Assertions.assertTrue(StandardImageTiler.incrementPosition(start, current, lengths));
        Assertions.assertArrayEquals(new int[] {2, 0}, current);

        Assertions.assertFalse(StandardImageTiler.incrementPosition(start, current, lengths));
    }
}
