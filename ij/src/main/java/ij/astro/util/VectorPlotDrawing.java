...
import static ij.gui.Plot.ARROW_NORTH_WEST;
import static ij.gui.Plot.ARROW_RIGHT;
...
import static ij.gui.Plot.CONNECTED_CIRCLES;
import static ij.gui.Plot.CROSS;
import static ij.gui.Plot.CUSTOM;
import static ij.gui.Plot.DIAMOND;
...
import static ij.gui.Plot.X_LOG_TICKS;
import static ij.gui.Plot.X_MINOR_TICKS;
import static ij.gui.Plot.X_NUMBERS;
import static ij.gui.Plot.X_TICKS;
import static ij.gui.Plot.Y_GRID;
import static ij.gui.Plot.Y_LOG_TICKS;
import static ij.gui.Plot.Y_MINOR_TICKS;
import static ij.gui.Plot.Y_NUMBERS;
import static ij.gui.Plot.Y_TICKS;
import static ij.gui.Plot.getDigits;
...
public class VectorPlotDrawing {
    ...
    public VectorPlotDrawing(Plot plot) {
    ...
    protected void drawPlotObject(Graphics2D g, IPlotObject plotObject) {
        ...
        switch (type) {
            ...
            case IPlotObject.NORMALIZED_LINE:
                g.setClip(mask);
                double ix1 = leftMargin + (plotObject.getX() * frameWidth);
                double iy1 = topMargin + (plotObject.getY() * frameHeight);
                double ix2 = leftMargin + (plotObject.getxEnd() * frameWidth);
                double iy2 = topMargin + (plotObject.getyEnd() * frameHeight);
