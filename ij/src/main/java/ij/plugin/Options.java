...
public class Options implements PlugIn {
	...
	@AstroImageJ(reason = "Add .tbl for file extensions", modified = true)
	void io() {
		...
		gd.addStringField("File extension for tables (.tbl, .csv, .tsv, or .txt):", Prefs.defaultResultsExtension(), 4);
