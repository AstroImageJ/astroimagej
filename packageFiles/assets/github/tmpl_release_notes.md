...
- **macOS**
  ...
  - **ARM64 (Apple Silicon)**:
    [AstroImageJ-{{VERSION}}-mac-aarch64.pkg](https://github.com/{{REPO}}/releases/download/{{VERSION}}/AstroImageJ-{{VERSION}}-mac-aarch64.pkg)

  - **x64 (Intel)**:
    [AstroImageJ-{{VERSION}}-mac-x64.pkg](https://github.com/{{REPO}}/releases/download/{{VERSION}}/AstroImageJ-{{VERSION}}-mac-x64.pkg)
